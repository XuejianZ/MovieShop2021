...
namespace MovieShop.UnitTestProject1
{
    [TestClass]
    public class MovieServiceUnitTest
    {
        /*
         * Arrange: Initializes object, create mocks with arguments that are passed to the method under test
         * and adds expectations.
        ...
        public void OneTimeSetup()
        {
            ...
            //SUT System under Test MoviesService => Get30HighestGrossing
        ...
        [TestMethod]
        public async Task TestListOfHighestGrossingMoviesFRromFakeData()
        {
            //SUT System under Test MoviesService => Get30HighestGrossing

            //Arrange
            //mock objects, data,method etc

            //   _sut = new MovieService(new MockMovieRepository());

            //Act 
            var movies = await _sut.Get30HighestGrossing();
            //check the actual output wit expected data.
        ...
        /* public class MockMovieRepository: IMovieRepository
         {
             ...
             {
                 //this method will get he fake data
